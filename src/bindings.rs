...
fn bindgen_test_layout_Hacl_HMAC_DRBG_state_s() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Hacl_HMAC_DRBG_state_s>())).k as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Hacl_HMAC_DRBG_state_s>())).v as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(Hacl_HMAC_DRBG_state_s),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Hacl_HMAC_DRBG_state_s>())).reseed_counter as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
